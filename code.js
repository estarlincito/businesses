...
menuID.innerHTML = `
  ...
  <a href="https://${window.location.host}/businesses/social_network/social-network.html">Social-N</a>
  </div>
`;
...
if (window.location.pathname === "/businesses/businesses/businesses.html") {
  businesses(businessesID, userName);
}

//if /businesses/social_network/social-network.html
if (window.location.pathname === "/businesses/social_network/social-network.html") {
